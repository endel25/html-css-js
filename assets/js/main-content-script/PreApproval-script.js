...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchGender() {
        try {
            const response = await fetch('https://192.168.3.74:3001/gender');
            if (!response.ok) {
    ...
    async function checkContactNumber(contactnumber) {
        ...
        try {
            const response = await fetch(`https://192.168.3.74:3001/appointment/contactnumber/${encodeURIComponent(contactnumber)}`, {
                method: 'GET',
