                    ...
                    tr.innerHTML = `
                        ...
                        <td>
                            <div class="action-buttons">
                                <svg class="action-btn edit-btn" onclick="${editHandler}(${item.id})" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg class="action-btn delete-btn" onclick="${deleteHandler}(${item.id})" width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    try {
        ...
        renderTableData('DesignationTable', designations, 'openEditDesignationModal', 'deleteDesignation'); // Corrected ID
    } catch (error) {
        ...
        showMessage('Failed to load designations: ' + error.message, 'error');
            ...
            if (addDesignationForm) {
                addDesignationForm.addEventListener('submit', async function (e) {
                    e.preventDefault();
                    const name = document.getElementById('DesignationName').value.trim(); // Corrected ID
                    if (!name) {
